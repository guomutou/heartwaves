            ...
            <div class="col-lg-12">
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <?php if($_GET['id']!= ''): ?><form method="post" class="form-horizontal" action="<?php echo U('Friendlink/doUpdate',array('id'=>$arr['id']));?>" enctype="multipart/form-data">
                        <?php else: ?>
                        <form method="post" class="form-horizontal" action="<?php echo U('Friendlink/doAdd');?>" enctype="multipart/form-data"><?php endif; ?>
