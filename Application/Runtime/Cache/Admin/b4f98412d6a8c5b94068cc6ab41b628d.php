...
<body>
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <a href = "/heartwaves/index.php/Admin/Recordmanager/record"><div class="viewall">查看全部</div></a>
                    </div>
                    <div class="ibox-content">

                    <table class="table table-striped table-bordered table-hover dataTables-example"  id="uid">
                    <thead>
                    <form name = "form1" action = "/heartwaves/index.php/Admin/Recordmanager/recordSearch" method = "get">
           ...
           <!--  <div style = "width:250px;display:inline-block;float:left;margin:20px 10px;"><span style = "font-size:15px;font-weight:bold;">记录时间:</span>&nbsp;&nbsp;&nbsp;&nbsp;<input type = "date" name = "time" placeholder = "记录时间"></div> -->
            <div style = ""><span style = "font-size:15px;font-weight:bold;">类型:</span>
            <select style = "width:100px;" name = "sel">
  ...
  <div style = "float: right;margin: -47px 426px;">
            ...
            <form method="post" action="" id="myFormid">  
                            <a href="http://123.206.62.179/heartwaves/index.php?m=Admin&c=Recordmanager&a=getline&id=<?php echo ($vo["id"]); ?>"><button type="button" class="btn btn-w-m btn-danger">查看</button></a>
                            <a href="/heartwaves/index.php/Admin/Recordmanager/recordDelet/id/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
            ...
            <?php echo ($page); ?>
                ...
                <button onclick="deletes()" style="position: absolute;bottom: 50px;left:150px;">批量删除</button>
                <button class="report" onclick="report()">导出记录</button>
            </form>
                ...
                <div style="position: absolute;bottom: 50px;right:160px;font-size:14px;">总共&nbsp;<?php echo ($count); ?>&nbsp;条记录</div>
...
<script>
 ...
 <script type="text/javascript">
        ...
        function deletes(){
           var action = document.getElementById("myFormid").action="/heartwaves/index.php/Admin/Recordmanager/deletesrecord";
        }
        function report(){
           var action = document.getElementById("myFormid").action="/heartwaves/index.php/Admin/Recordmanager/bbb";
        }
    </script>