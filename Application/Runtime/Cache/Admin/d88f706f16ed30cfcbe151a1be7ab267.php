        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
            <form name = "form1" action = "/heartwaves/index.php/Admin/Organizeconstruct/editorgOk/id/<?php echo ($data[0]["id"]); ?>" method = "post">
                            <tr class="gradeU">
            <!-- <td><input type = "text" name = "id" value = "<?php echo ($data[0]["id"]); ?>" readonly></td> -->
                ...
                <td>
                 <select name = "identity" >
                            <option value="<?php echo ($data[0]["js_name"]); ?>" selected><?php echo ($data[0]["js_name"]); ?></option>
