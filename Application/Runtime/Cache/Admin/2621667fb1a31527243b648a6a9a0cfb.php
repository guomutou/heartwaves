    ...
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
			...
			<th>操作</th>			
                    ...
                    <tbody>
			<form name = "form1" action = "/heartwaves/index.php/Admin/Recordmanager/editJsOk/uid/<?php echo ($data[0]["id"]); ?>" method = "post">
                            <tr class="gradeU">
			<td><input type = "text" name = "id" value = "<?php echo ($data[0]["id"]); ?>" disabled></td>
                        	<td><input type = "text" name = "name" value = "<?php echo ($data[0]["nickname"]); ?>" disabled></td>
                        	<td><input type = "text" name = "acode" value = "<?php echo ($data[0]["rkind"]); ?>" disabled></td>
			<!-- <td><input type = "text" name = "ctime" value = "<?php echo ($data[0]["diffculty"]); ?>" disabled></td> -->
			<td><input type = "text" name = "ctime" value = "<?php echo ($data[0]["s_time"]); ?>" disabled></td>
			<td><input type = "text" name = "ctime" value = "<?php echo ($data[0]["time_length"]); ?>" disabled></td>
			<td><input type = "text" name = "ctime" value = "<?php echo ($data[0]["evaluation"]); ?>" disabled></td>
			<td><input type = "text" name = "ctime" value = "<?php echo ($data[0]["remark"]); ?>" disabled></td>
			    <td>
                           	 <input type="submit" name = "submit" value = "返回" class="btn btn-w-m btn-info" onclick = "history.back();"></a>
