            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <a href = "/heartwaves/index.php/Admin/Organizeconstruct/jsmanager"><div class="viewall">查看全部</div></a>
                    </div>
     <!--    <script type = "text/javascript">
            function search(){
            var x = document.getElementById("sear");            
            window.location = "http://120.27.98.52/heartwaves/index.php?m=Admin&c=Organizeconstruct&a=jsSearch&str="+x.value;
        }
        </script> -->
                    ...
                    <thead>
          <!--   <?php if($count >= 5){ ?>
            <a href = "/heartwaves/index.php/Admin/Organizeconstruct/jsAdd" readonly>
                <button type = "button" disabled="disabled"> 新增角色</button>
            </a>&nbsp;&nbsp;
            <?php }else{ ?>
            <a href = "/heartwaves/index.php/Admin/Organizeconstruct/jsAdd">
                <button type = "button"> 新增角色</button>
            </a>&nbsp;&nbsp;
            <?php } ?>
            &nbsp;&nbsp;&nbsp;&nbsp;<input  id="sear" type = "text" name = "search" placeholder = "角色名搜索" onchange = "search()" ><br><br> -->
                    <tr>
                       <!--  <th>序号</th> -->
                        <th>角色名</th>
                        <th>角色描述</th>
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                       <!--  <td><?php echo ($vo["id"]); ?></td> -->
                        ...
                        <td style = "width:500px;">
                           <a href="/heartwaves/index.php/Admin/Organizeconstruct/editJs/uid/<?php echo ($vo["id"]); ?>" 
        ...
        <input type="hidden" name="" value="<?php echo ($count); ?>"  id="total">
