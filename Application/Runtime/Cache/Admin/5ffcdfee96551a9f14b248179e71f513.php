    ...
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
			...
			<th>操作</th>			
                    ...
                    <tbody>
			<form name = "form1" action = "/heartwaves/index.php/Admin/Organizeconstruct/addorgOk" method = "post">
                            <tr class="gradeU">
                        	<td><input id="tel" type = "text" name = "name" placeholder="添加后不可更改，请确认！"></td>
