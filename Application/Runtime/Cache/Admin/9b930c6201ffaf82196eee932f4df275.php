...
<body>
    <div id="wrapper">
        ...
        <script type = "text/javascript">
            ...
            window.location = "http://123.206.62.179/heartwaves/index.php?m=Admin&c=Organizeconstruct&a=orgSearch&str="+x.value;
        }
        </script>
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                       <!--  <td><?php echo ($vo["id"]); ?></td> -->
                        ...
                        <td style = "width:500px;">
                           <a href="/heartwaves/index.php/Admin/Organizeconstruct/editorg/id/<?php echo ($vo["id"]); ?>" target="_blank"><button type="button" class="btn btn-w-m btn-info">编辑</button></a>
                            <a href="/heartwaves/index.php/Admin/Organizeconstruct/viewuser/id/<?php echo ($vo["id"]); ?>" target="_blank"><button type="button" class="btn btn-w-m btn-danger">查看用户</button></a>
                            <a href="/heartwaves/index.php/Admin/Organizeconstruct/deleteorg/id/<?php echo ($vo["id"]); ?>"  onclick= "if(confirm( '如果删除该组，组内的成员将一起被删除 ')==false)return   false; " target="_blank"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
