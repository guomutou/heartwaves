        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr class="gradeU">
                        <form name = "form1" action = "<?php echo U('Jingli/editname');?>" method = "post">
                         <td class="catt"><input type="text" name="username" value="<?=$data['username']?>" attid="<?=$data['id']?>"></td>
                         <td class="capass"><input type="text" name="password" value="*****" attid="<?=$data['id']?>"></td>
                         <input type="hidden" name="id" value="<?=$data['id']?>">
                          <input type="submit" name = "submit" value = "提交" class="btn btn-w-m btn-info" ></a>
                            </form>
                        <td><?=date('Y-m-d H:i:s',$_SESSION['lat_time'])?></td>
                        <td><?=$data['zhanghu']?></td>
                        <td><?=$data['frost']?></td>
                        <td><?=$data['total']?></td>
<td></td>
...
<script>
	...
	<script type="text/javascript">
        ...
        //                         } ;
        //    //发送post请求
        //     $.post("<?php echo U('Jingli/editname');?>",PostData,
        //         function(data){
        //         });

        // })
        //    $('.capass input').blur(function(){
        //     //获取值
        //         var id= $(this).attr("attid");
        //         var va= $(this).val();
        //         var PostData= {
        ...
        //                         } ;
        //    //发送post请求
        //     $.post("<?php echo U('Jingli/editpassword');?>",PostData,
        //         function(data){
        //         },'json');
