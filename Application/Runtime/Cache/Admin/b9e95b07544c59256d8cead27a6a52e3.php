                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                            ...
                            <a href="<?php echo U('Liuyan/replydesc',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-w-m btn-danger">查看详情</button></a>
                            <a href="<?php echo U('Liuyan/reply',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-w-m btn-danger">回复</button></a>
                        </td>
...
<script>
    ...
    <!-- Toastr -->
       ...
       <link href="/heartwaves/Public/css/plugins/iCheck/custom.css" rel="stylesheet">
   <script src="/heartwaves/Public/js/plugins/iCheck/icheck.min.js"></script>
    <script>
