                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="<?php echo U('Liuyan/replyadd');?>">
                                <div class="form-group has-success"><label class="col-sm-4 control-label">标题</label>
                                ...
                                <div class="form-group"><label class="col-sm-4 control-label">留言内容</label>
                            ...
                            <input type="submit" value="发布" class="btn btn-primary" data-toggle="modal">
                            </div>
