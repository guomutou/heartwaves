...
body{background-color: rgb(239,239,244);}
    *{padding:0px;margin:0px;}
    ...
    .base span{border-radius: 5px;background-color: rgba(58,179,181,0.6);line-height: 20px;height: 20px;padding-left: 2%;padding-right: 2%;padding-top: 3px;padding-bottom: 3px;}
...
<input type="hidden" id="nb" value="<?php echo ($nb); ?>">
    ...
    <div class="base">
        <ul>
            ...
            <li>记录类型：<span><?php  if ($datas["rkind"] == 1){ echo "基线测试"; } else if ($datas["rkind"] == 2){ echo "5分钟测试"; } else if ($datas["rkind"] == 3){ echo "10分钟测试"; } else if ($datas["rkind"] == 61){ echo "荷韵"; } else if ($datas["rkind"] == 62){ echo "梅花"; } else if ($datas["rkind"] == 63){ echo "丝绸之路"; } else if ($datas["rkind"] == 64){ echo "菩提树"; } else if ($datas["rkind"] == 65){ echo "生命之泉"; } else if ($datas["rkind"] == 66){ echo "星空"; } else if ($datas["rkind"] == 41){ echo "挪来移去"; } else if ($datas["rkind"] == 42){ echo "看图绘画"; } else if ($datas["rkind"] == 43){ echo "边缘视力"; } else if ($datas["rkind"] == 44){ echo "多彩球"; } else if ($datas["rkind"] == 45){ echo "方向瞬记"; } else if ($datas["rkind"] == 46){ echo "以此类推"; } else if ($datas["rkind"] == 70){ echo "神笔马良"; } else if ($datas["rkind"] == 71){ echo "冒险岛"; } else if ($datas["rkind"] == 72){ echo "射箭"; } else if ($datas["rkind"] == 20){ echo "情境仿真"; } else{ echo "放松训练"; }?>
            </span></li>
        </ul>
        <ul>
    ...
    <div style="margin-bottom:20px;"><div id="line" style="width: 100%;height:300px;"></div></div>
    <div style="margin-top:-30px;background-color:rgba(124,210,251,0.6);width:22.7%;height:159px;margin-bottom:-220px;margin-left:14%;">&nbsp;</div>

    <div id="main" style="width: 88%;height:250px;margin-left:6%;"></div><div style="margin-top:-40px;background-color:rgba(153,134,239,0.6);width:46%;height:159px;margin-top:-189px;margin-left:36.5%;">&nbsp;</div>
    ...
    <table>
        ...
        <tr>
            ...
            <td rowspan="3">
                <div  style="background:url('/heartwaves/Public/img/111.png') no-repeat    center       center;background-size:auto auto;height:140px;position: relative;">
                    <img id="img" src="/heartwaves/Public/img/aa.png" style="position: relative;top:44px;width:10px;height:100px;">
                </div>
                </div>
                <div>自主神经系统平衡状态</div>
            </td>
    ...
    <!-- <a href="<?php echo U('Recordmanager/aaa');?>&id=<?php echo ($datas['id']); ?>"><div class="report">导出记录</div></a> -->
</div>
