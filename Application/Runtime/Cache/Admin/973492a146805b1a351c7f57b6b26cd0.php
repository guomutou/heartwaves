    ...
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
			...
			<th>操作</th>			
                    ...
                    <tbody>
			<form name = "form1" action = "/heartwaves/index.php/Admin/Organizeconstruct/editAuthOk/aid/<?php echo ($data[0]["id"]); ?>" method = "post">
                            <tr class="gradeU">
			<td><input type = "text" name = "id" value = "<?php echo ($data[0]["id"]); ?>" disabled></td>
                        	...
                        	<td><input type = "text" name = "acode" value = "<?php echo ($data[0]["acode"]); ?>"></td>
