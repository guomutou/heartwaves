...
<body>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <a href = "/heartwaves/index.php/Admin/Jingli/usermanager"><div class="viewall">返回上一级</div></a>
                    </div>
			  ...
			  <th>操作</th>			
                    ...
                    <tbody>
			<form name = "form1" action = "/heartwaves/index.php/Admin/Jingli/addjingli" method = "post">
                            <tr class="gradeU">
                        	<td><input type = "text" name = "username" placeholder="添加后不可更改，请确认！"></td>
                                <td><input type = "text" name = "kouling" placeholder="添加后不可更改，请确认！"></td>
  ...
  <td>
                        <input  name="endtime" class="sang_Calender" type="text" value=""></td>
                        	<!--<td><input  type = "text" name = "workingPlace" ></td>-->
