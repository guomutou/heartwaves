                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="<?php echo U('Gonggao/doedit',array('id'=>$arr['id']));?>">
                                ...
                                <div class="form-group"><label class="col-sm-4 control-label">公告内容</label>
                                    ...
                                    <div class="col-sm-3">
                                    <textarea name = "content" cols="30" rows="10"> <?php echo ($arr["content"]); ?></textarea>
                                    </div>
                                </div>
                               <div class="ibox-content">
