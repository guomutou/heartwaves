...
<head>
    ...
    <link href="/heartbrain/Public/css/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet">
    <link href="/heartbrain/Public/css/plugins/dataTables/dataTables.responsive.css" rel="stylesheet">
    <link href="/heartbrain/Public/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
    <!-- Toastr style -->
    <link href="/heartbrain/Public/css/plugins/toastr/toastr.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="/heartbrain/Public/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
                   ...
                   <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="hr-line-dashed"></div>
                            ...
                            <input type="submit" value="修改" class="btn btn-primary" data-toggle="modal" name = "submit">
...
<script type="text/javascript">
    ...
    <!-- Flot -->
    <script src="/heartbrain/Public/js/plugins/flot/jquery.flot.js"></script>
    <script src="/heartbrain/Public/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/heartbrain/Public/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/heartbrain/Public/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/heartbrain/Public/js/plugins/flot/jquery.flot.pie.js"></script>

    <!-- Peity -->
    <script src="/heartbrain/Public/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/heartbrain/Public/js/demo/peity-demo.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="/heartbrain/Public/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- GITTER -->
    <script src="/heartbrain/Public/js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="/heartbrain/Public/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/heartbrain/Public/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="/heartbrain/Public/js/plugins/chartJs/Chart.min.js"></script>
<script>
