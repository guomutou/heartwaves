...
<body>
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
			...
			window.location = "http://120.27.98.52/heartwaves/index.php?m=Admin&c=Organizeconstruct&a=authSearch&str="+x.value;
		}
		</script>
                    ...
                    <thead>
			<!-- <a href = "/heartwaves/index.php/Admin/Organizeconstruct/addAuth"><button type = "button">增加权限</button></a>&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;<input type = "text" name = "search" placeholder = "搜索" onchange = "search()" id = "sear"> -->
                    <tr>
                        <th>权限名</th>
		      <!-- <th>权限代码</th> -->
                        <th>权限描述</th>
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                       ...
                       <!--  <td style = "width:500px;">
                          <a href="/heartwaves/index.php/Admin/Organizeconstruct/editAuth/aid/<?php echo ($vo["id"]); ?>" target="_blank"><button type="button" class="btn btn-w-m btn-info">修改</button></a>
                          <a href="/heartwaves/index.php/Admin/Organizeconstruct/delete/id/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">查看</button></a>
                           <a href="/heartwaves/index.php/Admin/Organizeconstruct/deleteAuth/aid/<?php echo ($vo["id"]); ?>" onclick = "return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
