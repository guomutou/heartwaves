            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <a href = "/heartwaves/index.php/Admin/Liuyan/orgmanager"><div class="viewall">返回上一级</div></a>
                    </div>
                    ...
                    <tbody>
			<form name = "form1" action = "/heartwaves/index.php/Admin/Liuyan/reply" method = "post">
                            <tr class="gradeU">
